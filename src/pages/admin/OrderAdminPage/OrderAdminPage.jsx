...
const OrderAdminPage = () => {
    ...
    useEffect(() => {
        axios.get('https://localhost:3000/api/admin/order' , {
            headers: {
    ...
    function handleCancle(id) {
        axios.post(`https://localhost:3000/api/admin/order/cancle/${id}`)
        .then(response => {
    ...
    function handleConfirm(id) {
        axios.post(`https://localhost:3000/api/admin/order/confirm/${id}`)
        .then(response => {
            setShouldUpdate(true);
            setStatus(response.status)
        })
